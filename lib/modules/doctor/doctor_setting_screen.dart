  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<DoctorSettingCubit, DoctorSettingStates>(
        ...
        if (state is DoctorSettingSuccessState && state.message != null) 
          showToast(message: '${state.message}', error: false);
        

        if (state is DoctorSettingErrorState) 
          showToast(message: 'Server Error 500', error: true);
                                ...
                                ExpansionTileCard(
                                  ...
                                  title: Text(
                                    DoctorSettingCubit.get(context)
                                        .doctorData
                                        .result
                                        .availabilityList[appoinmentTypeIndex]
                                        .vendorAppointType,
                                    maxLines: 1,
